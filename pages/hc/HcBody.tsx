...
const HcBody = () => {
    ...
    return (
        <div>
            ...
            <section>
                <div className="bg-[#f5f6f7] mt-16 mx-5 md:mx-0">
                    <div className="">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-8">
                    {
                        HcCards.map(card =>
                            <div onClick={() => router.push(`hc/${card.slug}`)} key={card.id} className="text-[#2a5bd7] border border-[#2a5bd7] py-8 px-10 text-center cursor-pointer hover:bg-[#2a5bd7] hover:text-[#fff] transition-all ease-in mx-5 md:mx-0">
            ...
            <section className='py-20 mx-5 md:mx-0'>
                ...
                <div className="bg-[#f5f6f7] mt-16 mx-5 md:mx-32 text-[15px]">
