...
import { Press_data } from './fake_data';
import { Bottom_data } from './bottom_data';
    ...
    return (
        <Layout>
            <div className='lg:px-24 px-8 pt-24'>
                ...
                <h1 className='text-6xl font-bold'>There is always something <br /> happening here.</h1>
                            ...
                            <div key={i}>
                                <div className='lg:flex py-3 gap-4 justify-between'>
                                    <div>
                                        ...
                                        <Link className='text-[#2a5bd7]' href='/'>Read More</Link>
                                    </div>
                                    <Image
                        ...
                        <div className='mt-6 border-[1px] border-gray-300 bg-white'>
                            <div className='px-4'>
                                ...
                                <div className='lg:flex gap-4 text-[#2a5bd7] pb-2'>
                                    <button className='bg-[#edf2fe] py-2 px-4 rounded-md'>Download .png</button>
                                    <button className='bg-[#edf2fe] px-4 py-2 rounded-md'>Download .png</button>
                                </div>
                            </div>
                        </div>
                        <div className='mt-6 border-[1px] border-gray-300 bg-white'>
                            <div className='px-4'>
                                ...
                                <h1 className='font-bold text-xl py-4'>Bltly Logo</h1>
                                <div className='lg:flex gap-4 text-[#2a5bd7] pb-2'>
                                    <a download="custom-filename.jpg" href=""><button className='bg-[#edf2fe] py-2 px-4 rounded-md'>Download .png</button></a>
                                    <button className='bg-[#edf2fe] px-4 py-2 rounded-md'>Download .png</button>
                                </div>
                            </div>
                        </div>
                ...
                <div className='py-24'>
                    <h1 className='text-4xl font-bold text-center'>For press related inquiries, please contact us.</h1>
                </div>
